...
public class ProviderDTO  implements java.io.Serializable {
    ...
    /**
     * Gets the providerId value for this ProviderDTO.
     * 
     * @return providerId
     */
    ...
    /**
     * Sets the providerId value for this ProviderDTO.
     * 
     * @param providerId
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "specialization"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
