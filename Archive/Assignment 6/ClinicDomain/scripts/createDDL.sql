...
CREATE TABLE TREATMENT (ID BIGINT NOT NULL, TTYPE VARCHAR(31), DIAGNOSIS VARCHAR(255), PROVIDERID BIGINT, patient_fk BIGINT, provider_fk BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE RADIOLOGYDATE (ID BIGINT NOT NULL, DATE DATE, radiology_fk BIGINT, PRIMARY KEY (ID))
