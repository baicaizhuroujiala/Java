...
public interface IPatientWebService {
	...
	@WebMethod
	public void addDrugTreatment(long tid, long pid, String diagnosis, String drug, float dosage) throws PatientNotFoundExn, AddingTreatmentExn;	
	@WebMethod
	public void addSurgery(long id, String diagnosis, Date date, long providerId) throws PatientNotFoundExn, AddingTreatmentExn;
	@WebMethod
	public void addRadiology(long id, String diagnosis, List<Date> dates, long providerId) throws PatientNotFoundExn, AddingTreatmentExn;
	@WebMethod
