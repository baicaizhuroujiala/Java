...
public class Patient implements Serializable {
	...
	//adding a treatment in the list,
	//the relationship between patient and treatment will be set,
	//Treatment table will have patient foreign key
	...
	protected void addTreatment (Treatment t, long providerId) throws TreatmentExn {
		this.treatmentDAO.addTreatment(t, providerId);	//persist treatment object in the database
		this.getTreatments().add(t);		//add t in the list of treatments
		if (t.getPatient() != this)
			t.setPatient(this);
	}
	
	public long addDrugTreatment (String diagnosis, String drug, float dosage, long providerId) throws TreatmentExn{
...
//		drugTreatment.setProviderId(providerId);
		...
		this.addTreatment(drugTreatment, providerId);
		return drugTreatment.getId();
	}
	
	public long addSurgery(String diagnosis, Date date, long providerId) throws TreatmentExn{
		Surgery surgery = new Surgery();
//		surgery.setProviderId(providerId);
		surgery.setDiagnosis(diagnosis);
		surgery.setDate(date);
		this.addTreatment(surgery, providerId);
		return surgery.getId();

	}
	
	public long addRadiology(String diagnosis, List<Date> dates, long providerId) throws TreatmentExn{
...
//		radiology.setProviderId(providerId);
		...
		this.addTreatment(radiology, providerId);
